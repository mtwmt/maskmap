...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppStoreServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(AppStoreService, [{
        key: "setLocal",
        value: function setLocal(city, area) {
          this.city = city;
          this.city$.next(city);
        ...
        key: "setCityList",
        value: function setCityList(ary) {
          this.getCityList = ary;
          this.getCityList$.next(this.getCityList);
        }
      }, {
        key: "setAreaList",
        value: function setAreaList(city) {
          this.getAreaList = this.getCityList.filter(function (e) {
            return e.Name === city;
          });
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/spinner/spinner.component.ts"); // import { LeafletModule } from '@asymmetrik/ngx-leaflet';
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _map_map_component__WEBPACK_IMPORTED_MODULE_5__["MapComponent"], _search_search_component__WEBPACK_IMPORTED_MODULE_8__["SearchComponent"], _masklist_masklist_component__WEBPACK_IMPORTED_MODULE_9__["MasklistComponent"], _spinner_spinner_component__WEBPACK_IMPORTED_MODULE_11__["SpinnerComponent"]],
      ...
      _createClass(AppService, [{
        ...
        value: function fetchTaiwanCity(city) {
          ...
          return this.httpClient.get("".concat(this.assetsUrl, "/counties.json")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            ...
            _this.appStoreService.setCityList(res);
          }));
        }
      }, {
        key: "fetchPharmacy",
        ...
        key: "featchTWGeo",
        value: function featchTWGeo() {
          return this.httpClient.get("".concat(this.assetsUrl, "/tw-county.geojson")).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) {
            return res.features; // const newGEO = res.features.reduce((total, arr) => {
  ...
  function srcAppMapMapComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var leaflet__WEBPACK_IMPORTED_MODULE_7___default =
    /*#__PURE__*/
    __webpack_require__.n(leaflet__WEBPACK_IMPORTED_MODULE_7__);
    /* harmony import */
    ...
    var leaflet_markercluster__WEBPACK_IMPORTED_MODULE_8___default =
    /*#__PURE__*/
    __webpack_require__.n(leaflet_markercluster__WEBPACK_IMPORTED_MODULE_8__);
      ...
      _createClass(MapComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.location$.subscribe(function (res) {
            ...
            _this4.map.setView(res, 9); // console.log('location', this.location)

          });
          Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["combineLatest"])(this.appService.featchTWGeo(), this.appStoreService.city$).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            return res;
          })).subscribe(function (res) {
            if (!res[1]) {
              return;
            ...
            if (_this4.countryLayer) {
              _this4.countryLayer.clearLayers();
            }

            var city = res[1];
            var geo = res[0].filter(function (e) {
              return e.properties.name === city;
            });
            _this4.countryLayer = leaflet__WEBPACK_IMPORTED_MODULE_7__["geoJSON"](null).addData(geo).addTo(_this4.map);
          });
        }
      }, {
        key: "ngAfterViewInit",
        ...
        value: function renderMap(list, cur) {
          ...
          leaflet__WEBPACK_IMPORTED_MODULE_7__["marker"](this.location, {
        ...
        value: function onPharmacy(info) {
          ...
          this.prevPoint = leaflet__WEBPACK_IMPORTED_MODULE_7__["marker"](info.coordinates, {
            icon: this.icons.red
        ...
        value: function addMarker(info) {
          var marker = leaflet__WEBPACK_IMPORTED_MODULE_7__["marker"](info.coordinates, {
    ...
    function () {
      ...
      _createClass(SearchComponent, [{
        ...
        value: function onCityChange(event) {
          ...
          this.city = event; // this.appStoreService.setPharmacyList(this.city);
